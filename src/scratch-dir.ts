 ...
 * dir (which boot also empties), so the grant never registers and the tab-ui.html
 * write fails with ERR_ACCESS_DENIED, leaving the tab window unable to open. We
